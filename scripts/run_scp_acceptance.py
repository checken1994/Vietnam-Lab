        ...
        env.update(
            {
                ...
                "SCP_CAPABILITY_SECRET": os.environ.get("SCP_CAPABILITY_SECRET", "acceptance-test-capability-secret-32bytes"),
                "OPENROUTER_API_KEY": os.environ.get("OPENROUTER_API_KEY", "acceptance-mock-openrouter-key"),
                ...
                "OPENAI_API_KEY": os.environ.get("OPENAI_API_KEY", "acceptance-mock-openai-key"),
